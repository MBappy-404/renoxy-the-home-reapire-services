...
const ShowAllService = ({ service }) => {
  ...
  return (
    <div className=''>
      <div class="bg-gray-900 group shadow-lg w-full h-full  rounded p-3">
        <div class=" relative">
          <img class="w-full block rounded transform hover:scale-zoom-105 relative transition duration-500 h-full lg:h-56" src={logo} alt=" " />
        ...
        <div class="p-5">
          ...
          <div className=''>
            <p class="text-gray-200 "> Service Fee: {price}</p>
          </div>
        </div>
      </div>
    </div>
